...
<br><br>
-- contents  
1. [~제어문(현재글)](https://sbeeeeeeen.github.io/python/python1/){:target="_blank"}
2. [~함수](https://sbeeeeeeen.github.io/python/python2/){:target="_blank"}
...
2씩 안빼면 10은 영원히 0보다 크기때문에 영원히 10을 찍어준다...
 ...
 <br><br> 
**다음글**  
[구글링으로 독학하는 파이썬2](https://sbeeeeeeen.github.io/python/python2/){:target="_blank"}  
